...
const products: IProductInput[] = [
  {
    name: 'MERCEDES-BENZ M-CLASS ML350',
    slug: toSlug('mercedes-benz-m-class-ml350-2015'),
    ...
    countInStock: 11,
    description:
      '2015 MERCEDES-BENZ M-CLASS ML350 BLUETEC 4MATIC AMG SPORT',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  {
    name: 'MERCEDES-BENZ C-CLASS C180-R17-AVANTGARDE-RCAM-PSTART',
    slug: toSlug('mercedes-benz-c-class-c180-r17-avantgarde-rcam-pstart'),
    category: 'MERCEDES-BENZ',
    images: [
      '/images/p12-1.jpg',
      '/images/p12-2.jpg',
    ...
    countInStock: 12,
    description:
      '2015 MERCEDES-BENZ C-CLASS C180-R17-AVANTGARDE-RCAM-PSTART',
  ...
  {
    name: "MERCEDES-BENZ C-CLASS C200 AVANTGARDE AMG LINE",
    slug: toSlug('mercedes-benz-c-class-c200-avantgarde-amg-line'),
    category: 'MERCEDES-BENZ',
    brand: 'MERCEDES-BENZ',
    ...
    countInStock: 13,
    description:
      '2016 MERCEDES-BENZ C-CLASS C200 AVANTGARDE AMG LINE',
    sizes: ['XL', 'XXL'],
    colors: ['Green', 'White'],
  ...
  },
  {
    ...
    countInStock: 14,
    description:
      '2015 MERCEDES-BENZ C-CLASS C250',
    sizes: ['XL', 'XXL'],
    colors: ['Yellow', 'White'],
  ...
  {
    name: "MERCEDES-BENZ C-CLASS HYBRID C350E AVANTGARDE",
    slug: toSlug(
      "mercedes-benz c-class hybrid c350e avantgarde"
    ),
    category: 'MERCEDES-BENZ',
    brand: 'MERCEDES-BENZ',
    ...
    countInStock: 15,
    description:
      "2017 MERCEDES-BENZ C-CLASS HYBRID C350E AVANTGARDE",
    sizes: ['XL', 'XXL'],
    colors: ['Green', 'Yellow'],
  ...
  {
    name: 'MERCEDES-BENZ M-CLASS ML350',
    slug: toSlug('mercedes-benz m-class ml350'),
    category: 'MERCEDES-BENZ',
    brand: 'Mercedes Benz',
  ...
  {
    name: "BMW X5 XDRIVE 30D XLINE",
    slug: toSlug(
      "bmw-x5-xdrive-30d-xline-2022"
    ),
    category: 'BMW',
    brand: "BMW",
  ...
  {
    name: 'BMW 3 SERIES 320I X DRIVE LUXURY',
    ...
    numSales: 54,
    description:
      '2013 BMW 3 SERIES 320I X DRIVE LUXURY',
    sizes: ['30Wx30L', '34Wx30L', '36Wx30L'],
    colors: ['Grey', 'Blue'],
  ...
  {
    name: "BMW 2 SERIES 218D ACTIVE TOURER",
    slug: toSlug(
    ...
    numSales: 53,
    description:
      '2019 BMW 2 SERIES 218D ACTIVE TOURER',
    sizes: ['30Wx30L', '34Wx30L', '36Wx30L'],
    colors: ['Blue', 'Grey'],
  ...
  {
    name: 'BMW X5 XDRIVE 45E XLINE',
    slug: toSlug('bmw-x5-xdrive-45e-xline-2023'),
    category: 'BMW',
    brand: 'BMW',
  ...
  // Toyota
  {
    name: "TOYOTA HILUX 2.4 E REVO DOUBLE CAB",
    slug: toSlug("toyota-hilux-2.4-e-revo-double-cab"),
    category: 'TOYOTA',
    brand: 'TOYOTA',
    ...
    numSales: 48,
    description:
      '2023 TOYOTA HILUX 2.4 E REVO DOUBLE CAB',
    sizes: [],
    colors: [],
  ...
  {
    name: 'TOYOTA HILUX GR SPORTS KIT INSTALLED',
    slug: toSlug(
      'toyota-hilux-gr-sports-kit-installed'
    ),
    category: 'TOYOTA',
    brand: 'TOYOTA',
    ...
    numSales: 48,
    description:
      '2023 TOYOTA HILUX GR SPORTS KIT INSTALLED',
    sizes: [],
    colors: [],
  ...
  {
    name: "TOYOTA HILUX REVO 2.4 E DOUBLE CAB",
    slug: toSlug(
      "toyota-hilux-revo-2.4-e-double-cab"
    ),
    category: 'TOYOTA HILUX REVO 2.4 E DOUBLE CAB',
    brand: 'TOYOTA',
    ...
    numSales: 48,
    description:
      '2020 TOYOTA HILUX REVO 2.4 E DOUBLE CAB',
    sizes: [],
    colors: [],
  ...
  {
    name: 'TOYOTA HILUX REVO 2.4 E DOUBLE CAB 2022',
    slug: toSlug(
      'toyota-hilux-revo-2.4-e-double-cab-2022'
    ),
    category: 'TOYOTA',
    brand: 'TOYOTA',
    ...
    numSales: 48,
    description:
      '2022 TOYOTA HILUX REVO 2.4 E DOUBLE CAB',
    sizes: [],
    colors: [],
  ...
  {
    name: "TOYOTA HILUX REVO 2.4 J SINGLE CAB",
    slug: toSlug("toyota-hilux-revo-2.4-j-single-cab"),
    category: 'TOYOTA',
    brand: 'TOYOTA',
    ...
    numSales: 48,
    description:
      '2023 TOYOTA HILUX REVO 2.4 J SINGLE CAB',
    sizes: [],
  ...
  },
  {
    ...
    slug: toSlug("toyota-landcruiser-prado"),
    category: 'TOYOTA LAND CRUISER PRADO',
    ...
    numSales: 49,
    description:
      '2022 TOYOTA LAND CRUISER PRADO',
    sizes: [],
  ...
  // HONDA FIT
  {
    name: 'HONDA FIT 13G F PACKAGE',
    slug: toSlug('honda-fit-13g-f-package-2014'),
    category: 'HONDA FIT',
    brand: 'HONDA FIT',
  ...
  {
    name: "HONDA FIT HYBRID L PACKAGE",
    slug: toSlug(
      "honda-fit-hybrid-l-package-2015"
    ),
    category: 'HONDA FIT',
    brand: 'HONDA FIT',
    ...
    numSales: 50,
    description:
      '2015 HONDA FIT HYBRID L PACKAGE',
    sizes: ['8', '9', '10'],
  ...
  {
    name: 'HONDA FIT HYBRID NAVI PREMIUM SELECTION',
    slug: toSlug(
      'honda-fit-hybrid-navi-premium-2011'
    ),
    category: 'HONDA FIT',
    brand: 'HONDA FIT',
    ...
    numSales: 72,
    description:
      '2011 HONDA FIT HYBRID NAVI PREMIUM SELECTION',
    sizes: ['8', '9', '10'],
  ...
  {
    name: 'HONDA FIT HYBRID SMART SELECTION',
    slug: toSlug(
      'honda-fit-hybrid-smart-2017'
    ),
    category: 'HONDA FIT',
    brand: 'HONDA FIT',
  ...
  },
  {
    ...
    slug: toSlug("honda-fit-hybrid-2018"),
    category: 'HONDA FIT',
    brand: 'HONDA FIT',
  ...
  webPages: [
    {
      title: 'About Us',
      slug: 'about-us',
      content: `Welcome to We Buy & Sell Cars Botswana, your trusted destination for quality products and exceptional service. Our journey began with a mission to bring you the best shopping experience by offering a wide range of products at competitive prices, all in one convenient platform.

At We Buy & Sell Cars Botswana, we prioritize customer satisfaction and innovation. Our team works tirelessly to curate a diverse selection of items, from everyday essentials to exclusive deals, ensuring there's something for everyone. We also strive to make your shopping experience seamless with fast shipping, secure payments, and excellent customer support.
...
`,
    ...
    },
    {
      ...
      content: `At We Buy & Sell Cars Botswana, our customer service team is here to ensure you have the best shopping experience. Whether you need assistance with orders, product details, or returns, we are committed to providing prompt and helpful support.
...
We also provide helpful resources such as order tracking, product guides, and FAQs to assist you with common inquiries. Your satisfaction is our priority, and we’re here to resolve any issues quickly and efficiently. Thank you for choosing us!`,
  ...
  carousels: [
    {
      title: 'Most Popular Cars For Sale',
      buttonCaption: 'Shop Now',
      image: '/images/banner3.jpg',
      url: '/search?category=HONDA FIT',
      isPublished: true,
    },
    {
      title: 'Best Sellers in Mercedes Benz',
      buttonCaption: 'Shop Now',
      image: '/images/banner1.jpg',
      url: '/search?category=MERCEDES BENZ',
      isPublished: true,
    },
    {
      title: 'Best Deals on BMW',
      buttonCaption: 'See More',
      image: '/images/banner2.jpg',
      url: '/search?category=BMW',
      isPublished: true,
    },
  ],
  settings: [
    {
      ...
      site: {
        name: 'We Buy & Sell Cars Botswana',
        description:
          'We Buy & Sell Cars Botswana is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
